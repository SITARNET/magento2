<?php
namespace Sitarnet\Jobs\Controller\Adminhtml\Job;
...
class Save extends Action
{
     ...
     * @param \Sitarnet\Jobs\Model\Job $model
     */
    public function __construct(
        Action\Context $context,
        \Sitarnet\Jobs\Model\Job $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Sitarnet_Jobs::job_save');
    }
