<?php
namespace Sitarnet\Jobs\Controller\Adminhtml\Department;
...
class Edit extends Action
{
    ...
    /**
     * @var \Sitarnet\Jobs\Model\Department
     */
    protected $_model;
     ...
     * @param \Sitarnet\Jobs\Model\Department $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Sitarnet\Jobs\Model\Department $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Sitarnet_Jobs::department_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Sitarnet_Jobs::department')
