<?php
namespace Sitarnet\Jobs\Block\Adminhtml\Job\Edit;
...
class Form extends Generic
{
     ...
     * @param \Sitarnet\Jobs\Model\Source\Job\Status $status
     * @param \Sitarnet\Jobs\Model\Source\Department $department
     * @param array $data
     */
    public function __construct(
        ...
        \Sitarnet\Jobs\Model\Source\Job\Status $status,
        \Sitarnet\Jobs\Model\Source\Department $department,
        array $data = []
    ) {
    ...
    {
        /** @var \Sitarnet\Jobs\Model\Job $model */
