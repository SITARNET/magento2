<?php namespace Sitarnet\Jobs\Setup;
...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '1.0.0.0') < 0) {
            ...
            /**
             * Create table 'sitarnet_jobs'
             */

            $tableName = $installer->getTable('sitarnet_job');
        ...
        if (version_compare($context->getVersion(), '1.0.0.2') < 0) {
            ...
            $tableName = $installer->getTable('sitarnet_department');
